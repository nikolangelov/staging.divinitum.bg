					...
					<div class="flex md-flex flex-col lg-gap-5 flex-justify-center max-w-1440px lg-px-0 mx-auto md:pb-10">
						...
						<div class="px-5 md-px-0 flex lg-flex-row flex-col lg-gap-10">
							<div class="lg-w-33.33% flex flex-col">
								<AnimatedComponent>
									<h3 class="c-brand text-left mt-0">Опит, на който можете да разчитате</h3>
									<div class="pb-8 c-paper">Зад всяка супер визия в The Barber Shop Sofia стои <span class="font-600">екип от изключителни професионалисти.</span> Всеки един от нашите топ бръснари в София е преминал задълбочен курс по бръснарство в The Barber Shop Academy. По време на интензивното обучение усвояват както <span class="font-600">класически бръснарски техники,</span> така и <span class="font-600">най-новите тенденции в подстригването.</span> След многократни упражнения и наблюдение от преподавателя най-добрите бръснари биват поканени да работят при нас.</div>
								</AnimatedComponent>
							</div>
							<div class="lg-w-33.33% flex flex-col">
								<AnimatedComponent>
									<h3 class="c-brand text-left mt-5 lg-mt-0">Всеки детайл има значение</h3>
									<div class="pb-8 c-paper">Качеството е основен приоритет в работата на нашата бръснарница. За целта използваме професионални бръснарски инструменти от световно утвърдени марки като <span class="font-600">Wahl, Andis, BabylissPRO, Mühle и Thiers Issard.</span> Всяка ножица и машинка е подбрана, заради нейната прецизна работа и удобство при различни техники на подстригване и бръснене. Благодарение на това можем да постигнем <span class="font-600">отличен краен резултат,</span> независимо от предпочитания стил.</div>
								</AnimatedComponent>
							</div>
							<div class="lg-w-33.33% flex flex-col">
								<AnimatedComponent>
									<h3 class="c-brand text-left mt-5 lg-mt-0">Първокласна грижа</h3>
									<div class="pb-8 c-paper">В The Barber Shop Sofia използваме професионални продукти за мъжка грижа от марки като <span class="font-600">Depot, American Crew и Lavish.</span> Асортиментът обхваща нуждите на различни типове кожа и коса и включва шампоани, балсами и стилизиращи продукти. В бръснарницата разполагаме с всичко необходимо за оформяне на желаната визия, както при работа с професионалист, така и за грижа у дома. Всеки продукт е специално подбран, за да осигури подходяща поддръжка за различните стилове и дължини на косата.</div>
								</AnimatedComponent>
							</div>
						</div>
					</div>
