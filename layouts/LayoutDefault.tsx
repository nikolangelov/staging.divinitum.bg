...
import { ContactUs } from '../pages/kurs-za-brasnar/+Page';
...
export default function LayoutDefault(props: { children?: JSX.Element }) {
  ...
  const isSpecialPage = pageContext.urlPathname === '/kurs-za-brasnar'
